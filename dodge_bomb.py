...
def main():
    ...
    kk_img = pg.transform.rotozoom(kk_img, 0, 2.0) #左
    kk_img_re = pg.transform.flip(kk_img, True, False)
    kk_img_0 = pg.transform.rotozoom(kk_img_re, 90, 1.0) #上
    kk_img_1 = pg.transform.rotozoom(kk_img_re, 45, 1.0) #右上
    kk_img_2 = pg.transform.rotozoom(kk_img_re, 0, 1.0) #右
    kk_img_3 = pg.transform.rotozoom(kk_img_re, -45, 1.0) #右下
    kk_img_4 = pg.transform.rotozoom(kk_img_re, -90, 1.0) #下
    kk_img_5 = pg.transform.rotozoom(kk_img, 45, 1.0) #左下
    kk_img_6 = pg.transform.rotozoom(kk_img, -45, 1.0) #左上
